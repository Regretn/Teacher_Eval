...
<template>
  ...
  <section id="sidebar">
    ...
    <ul class="side-menu top">
      <li class="active">
        <a href="#">
          <i class="ri-dashboard-line" :class="{ active: isnavbar }"></i>
          <span class="text">Dashboard</span>
        </a>
      </li>
      <li>
        <a href="#">
          <i class="ri-quill-pen-line" :class="{ active: isnavbar }"></i>
          <span class="text">Evaluation</span>
        </a>
      </li>
      <li>
        <a href="#">
          <i class="ri-message-2-fill" :class="{ active: isnavbar }"></i>
    ...
    <ul class="side-menu">
      <li>
        <a href="#" class="logout">
          <i class="bx bxs-log-out" :class="{ active: isnavbar }"></i>
  ...
  <section id="content">
    <!-- NAVBAR -->
    <nav>
      <i class="ri-menu-line" @click="test"></i>
